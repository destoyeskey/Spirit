...
lib.ssMetadata = [
		{name:"project 2_HTML5 Canvas_atlas_1", frames: [[1282,0,70,88],[1282,90,69,88],[0,0,1280,720]]}
];
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["project 2_HTML5 Canvas_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(980.1,632.7,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(892.45,632.7,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.abutton},{t:this.bbutton},{t:this.instance_1},{t:this.instance}]}).wait(1));
	...
	// bg
	this.instance_2 = new lib._final();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/project 2_HTML5 Canvas_atlas_1.png", id:"project 2_HTML5 Canvas_atlas_1"}
	],
	preloads: []
};
